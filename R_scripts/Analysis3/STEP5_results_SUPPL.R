...
dir.create("Results/Supplementary/Analysis3")
...
for (Capitani_ver in Capitani_vers){
  for (Arcara_ver in Arcara_vers){
    ...
    print(xtable(TRAIN_RES_UNIF, type = "latex"), file = paste("Results/Supplementary/Analysis3/TRAIN_RES_UNIF_A", Arcara_ver,"_C", Capitani_ver, ".tex", sep=""), include.rownames = F)
    print(xtable(TRAIN_RES_COND, type = "latex"), file = paste("Results/Supplementary/Analysis3/TRAIN_RES_COND_A", Arcara_ver,"_C", Capitani_ver, ".tex", sep=""), include.rownames = F)
    print(xtable(TEST_RES_UNIF, type = "latex"), file = paste("Results/Supplementary/Analysis3/TEST_RES_UNIF_A", Arcara_ver,"_C", Capitani_ver, ".tex", sep=""), include.rownames = F)
    print(xtable(TEST_RES_COND, type = "latex"), file = paste("Results/Supplementary/Analysis3/TEST_RES_COND_A", Arcara_ver,"_C", Capitani_ver, ".tex", sep=""), include.rownames = F)
