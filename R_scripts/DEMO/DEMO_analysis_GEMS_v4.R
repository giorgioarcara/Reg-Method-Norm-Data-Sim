...
library(MuMIn)
source("R_functions/adjscores_A2024_v4.R")
...
source("R_functions/dredge_loocv.R")
...
GEMS.mod = lm(GEMS~Age+Education+Sex, data=GEMS.dat)

curr_mod = GEMS.mod

dredge_loocv(GEMS.mod, dep="GEMS")
