## calculate adjusted scores according to Arcara (2024) method. - VERSION 1
# the function calculates adjusted scores via regression modeling. The model selection is made by fitting all possible models within a set of transformations
# (see the function) and select the model with the lowest AIC.
